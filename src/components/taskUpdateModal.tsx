...
import { Modal, Button, TextInput, Checkbox, MultiSelect, Group, Dialog } from '@mantine/core'
...
const UpdateTaskModal: React.FC<EditTaskModalProps> = ({ task, isOpen, onClose }) => {
