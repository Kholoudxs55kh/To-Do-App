...
export default class TaskDao {
  ...
  async updateTask(data: taskUpdateI) {
    try {
      ...
      if (e instanceof Error) {
        ...
        if (e.message === 'Task already exists within the last 24 hours') throw new Error(e.message)
  ...
  async hardDeleteTask(id: string) {
    try {
      ...
      if (e instanceof Error) if (e.message === 'Task not found') throw new Error(e.message)
